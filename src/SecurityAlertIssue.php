...
class SecurityAlertIssue extends JiraSecurityIssue
{
    ...
    public function __construct(array $data)
    {
        ...
        $this->safeVersion = isset ($data['securityVulnerability']['firstPatchedVersion']['identifier']) ? $data['securityVulnerability']['firstPatchedVersion']['identifier'] : "not-patched";
